 ...
 * @access 		public
 */
class XoopsFormSelectPerson extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPerson($caption, $name, $value = null, $size = 1, $multiple = false, $approved=true)
    {
        ...
        foreach($profile_handler->getObjects($criteria, true) as $pid => $profile)
			$this->addOption($pid, $profile->getVar('name'). ' ('.$profile->getVar('alias').')');						
