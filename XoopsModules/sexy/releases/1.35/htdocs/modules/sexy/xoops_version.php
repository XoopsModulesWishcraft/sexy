...
$modversion['templates'][2]['description'] = 'Sexy Index';
$modversion['templates'][3]['file'] = 'sexy_edit_pictures.html';
$modversion['templates'][3]['description'] = 'Sexy Picture Editing Index (Forms)';
$modversion['templates'][4]['file'] = 'sexy_edit_picture.html';
$modversion['templates'][4]['description'] = 'Sexy Picture Editing Index (Form)';
$modversion['templates'][5]['file'] = 'sexy_manage_form.html';
$modversion['templates'][5]['description'] = 'Sexy Picture Editing Table (Form)';
$modversion['templates'][6]['file'] = 'sexy_index_profile.html';
$modversion['templates'][6]['description'] = 'Sexy Index Profile';
$modversion['templates'][7]['file'] = 'sexy_edit_urls.html';
$modversion['templates'][7]['description'] = 'Sexy Edit URLS (Forms)';
$modversion['templates'][8]['file'] = 'sexy_edit_url.html';
$modversion['templates'][8]['description'] = 'Sexy Edit URL (Form)';
$modversion['templates'][9]['file'] = 'sexy_edit_prices.html';
$modversion['templates'][9]['description'] = 'Sexy Edit Prices (Forms)';
$modversion['templates'][10]['file'] = 'sexy_edit_price.html';
$modversion['templates'][10]['description'] = 'Sexy Edit Price (Form)';
$modversion['templates'][11]['file'] = 'sexy_edit_physique.html';
$modversion['templates'][11]['description'] = 'Sexy Edit Physique (Form)';
$modversion['templates'][12]['file'] = 'sexy_admin_edit_profile.html';
$modversion['templates'][12]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][13]['file'] = 'sexy_admin_edit_picture.html';
$modversion['templates'][13]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][14]['file'] = 'sexy_admin_edit_pictures.html';
$modversion['templates'][14]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][15]['file'] = 'sexy_admin_edit_url.html';
$modversion['templates'][15]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][16]['file'] = 'sexy_admin_edit_urls.html';
$modversion['templates'][16]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][17]['file'] = 'sexy_admin_sexy.html';
$modversion['templates'][17]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][18]['file'] = 'sexy_admin_edit_prices.html';
$modversion['templates'][18]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][19]['file'] = 'sexy_admin_edit_price.html';
$modversion['templates'][19]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][20]['file'] = 'sexy_admin_show.html';
$modversion['templates'][20]['description'] = 'Sexy Show List (Admin)';
$modversion['templates'][21]['file'] = 'sexy_admin_edit_show.html';
$modversion['templates'][21]['description'] = 'Sexy Edit (Admin)';
$modversion['templates'][22]['file'] = 'sexy_book_show.html';
$modversion['templates'][22]['description'] = 'Sexy Book Show (User)';
...
$modversion['config'][$i]['title'] = "_SXY_WIDEIMAGE";
$modversion['config'][$i]['description'] = "_SXY_WIDEIMAGE_DESC";
...
$modversion['config'][$i]['options'] = 	array(	_SXY_CRONTYPE_PRELOADER => 'preloader', 
...
$i++;
$modversion['config'][$i]['name'] = 'profile_sextype_field';
$modversion['config'][$i]['title'] = "_SXY_PROFILE_SEX_TYPE_FIELDNAME";
$modversion['config'][$i]['description'] = "_SXY_PROFILE_SEX_TYPE_FIELDNAME_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = 'sex';

$i++;
$modversion['config'][$i]['name'] = 'profile_male_value';
$modversion['config'][$i]['title'] = "_SXY_PROFILE_FIELD_MALE_VALUE";
$modversion['config'][$i]['description'] = "_SXY_PROFILE_FIELD_MALE_VALUE_DESC";
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = 'male';
