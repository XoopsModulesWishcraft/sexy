...
/**
 * XoopsFormCheckBoxPhysiqueActions
 *
 * @author 		Kazumi Ono <onokazu@xoops.org>
 * @author 		Skalpa Keo <skalpa@xoops.org>
 * @author      Taiwen Jiang <phppp@users.sourceforge.net>
 ...
 * @access 		public
 */
class XoopsFormCheckBoxPhysiqueActions extends XoopsFormElement
{
    /**
     * Availlable options
     *
     ...
     */
    function XoopsFormCheckBoxPhysiqueActions($caption, $name, $value = null, $delimeter = '<br/>')
    {
		...
		foreach(sexy_ActionsArray() as $id => $value)
