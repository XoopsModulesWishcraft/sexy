 ...
 * @access 		public
 */
class XoopsFormSelectLocation extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectLocation($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        $this->setCaption($caption);
        $this->setName($name);
        $this->_multiple = $multiple;
        $this->_size = intval($size);
		foreach(sexy_LocationArray() as $id => $value)
