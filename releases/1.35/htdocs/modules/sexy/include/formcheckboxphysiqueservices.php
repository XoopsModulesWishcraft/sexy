...
/**
 * XoopsFormCheckBoxPhysiqueServices
 *
 * @author 		Kazumi Ono <onokazu@xoops.org>
 * @author 		Skalpa Keo <skalpa@xoops.org>
 * @author      Taiwen Jiang <phppp@users.sourceforge.net>
 ...
 * @access 		public
 */
class XoopsFormCheckBoxPhysiqueServices extends XoopsFormElement
{
    /**
     * Availlable options
     *
     ...
     */
    function XoopsFormCheckBoxPhysiqueServices($caption, $name, $value = null, $delimeter = '<br/>')
    {
		...
		foreach(sexy_ServicesArray() as $id => $value)
